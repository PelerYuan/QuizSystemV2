                            ...
                            <div className="h-80 w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={sortedScores} margin={{top: 10, right: 10, left: -20, bottom: 0}}>
                                        ...
                                        <YAxis domain={[0, data.maxScore]} tick={{fill: '#64748b', fontSize: 12}} tickLine={false} axisLine={false} />
                                        <RechartsTooltip cursor={{fill: '#f8fafc'}} contentStyle={{ borderRadius: '8px', border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }} />
                                        <ReferenceLine y={data.averageScore} stroke="#f59e0b" strokeDasharray="3 3" label={{ position: 'top', value: 'Avg', fill: '#f59e0b', fontSize: 12 }}/>
